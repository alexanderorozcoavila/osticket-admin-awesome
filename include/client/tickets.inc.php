...
<div class="search well">
	...
	<form action="tickets.php" method="get" id="ticketSearchForm">
		...
		<input type="text" name="keywords" size="30" value="<?php echo Format::htmlchars($settings['keywords']); ?>" placeholder="<?php echo __('Search'); ?>"/>		
		
		<button type="submit" class="button ticket-search action-button"><i class="icon-search"></i></button>    
...
<caption><?php echo $showing; ?></caption><br /><br />
<table id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
    <thead>
        <tr>
            <th nowrap>
                <a href="tickets.php?sort=ID&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="Sort By Ticket ID">#</a>
            </th>
            <th width="120">
...
<!-- OR -->
        <td class="ticket-mobile" rowspan="2">
                <a class="Icon <?php echo strtolower($T['source']); ?>Ticket" title="<?php echo $T['user__default_email__address']; ?>"
                    href="tickets.php?id=<?php echo $T['ticket_id']; ?>"><?php echo $ticketNumber; ?></a>
     	</td>
      	<td>
    ...
    <tr>
    	<td class="ticket-mobile" colspan="3">
					<div style="max-height: 1.2em; max-width: 320px;" class="link truncate" href="tickets.php?id=<?php echo $T['ticket_id']; ?>"><?php echo $subject; ?></div>
    	</td>
    </tr>
        <?php
